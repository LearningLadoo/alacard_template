      ...
      child: Column(
        children: [
          Align(
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal:small*3/2,vertical: small),
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal:small*3/2),
            child: Align(
              alignment: Alignment.centerLeft,
            ...
            child: ClipRRect(
              ...
              child: Container(
                  ...
                  child: RawScrollbar(
                    ...
                    thumbColor: themeData.primaryColorDark,
                    radius: Radius.circular(small),
                    child: ListView.builder(
                        padding: EdgeInsets.fromLTRB(small*3/2,0.0,small*3/2,0.0),// for scroll bar
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          String tempSubPath = getTemplateSubPath(cardData: CardData(templateName: {"tempCode":_m["id"],"source":"inbuilt","templateType":_m["type"]}))!;
